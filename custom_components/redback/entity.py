...
class RedbackEntity(CoordinatorEntity[RedbackDataUpdateCoordinator]):
    ...
    def __init__(self, coordinator: RedbackDataUpdateCoordinator, details) -> None:
        ...
        self._attr_device_info = DeviceInfo(
            ...
            sw_version=coordinator.inverter_info["SoftwareVersion"],
            hw_version=coordinator.inverter_info["FirmwareVersion"],
            configuration_url="https://portal.redbacktech.com/",
            serial_number=coordinator.inverter_info["SerialNumber"],
        )


class RedbackNumberEntity(CoordinatorEntity[RedbackDataUpdateCoordinator]):
    """Base class for Redback entities"""
